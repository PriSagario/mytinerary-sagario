...
const itineraryController = {
  ...
  returnItinerary: (req, res) => {
    ...
    createItinerary:(req,res) =>{
      const {itineraryName, userName, userImg, price, likes, duration, hashtags,comments} = req.body
      const itinerary = new City({itineraryName,userName,userImg, price, likes, duration, hashtags,comments}).save
      .then((response) => res.json((response)))
